...
<main class="flex-grow relative w-full">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
                <div class="flex flex-col lg:flex-row gap-8">
                            ...
                            <div id="product-carousel" class="flex w-full h-full transition-transform duration-500 ease-out">
                                ...
                                <div class="w-full h-full flex-shrink-0 flex-grow-0">
                                    <img src="{{ asset('storage/' . $image) }}" 
                                         alt="{{ $item->nama_fasilitas }} - Image {{ $index + 1 }}"
                    ...
                    <div class="lg:w-7/12 flex flex-col">
                        <!-- Product Name -->
                        <h2 class="text-3xl font-bold text-gray-800 mb-4">{{ $item->nama_fasilitas }}</h2>
                        ...
                        <div class="flex items-center gap-4 mt-auto">
                            ...
                            <!-- Rent Button -->
                            <a href="{{ route('user.fasilitas-umum.book', $item->id) }}?quantity={{ $item->stok > 0 ? 1 : 0 }}" 
                               id="rent-button"
                               data-turbo="false"
    ...
    <x-unit-chat-widget 
        service="fasilitas_umum" 
        title="Layanan Fasilitas Umum" 
...
(() => {
    function initFasilitasDetail() {
        ...
        function updateRentButtonUrl() {
            ...
            rentButton.href = `/unit-peminjaman-fasilitas-umum/${itemId}/booking?quantity=${qty}`;
        }
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFasilitasDetail);
    } else {
        initFasilitasDetail();
    }
    document.addEventListener('turbo:load', initFasilitasDetail);
})();
</script>
@endpush
