    ...
    <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div id="mutasi-section-container" class="mt-8 w-full glass-card rounded-3xl p-6 sm:p-8 border border-white/50 shadow-lg relative overflow-hidden transition-all duration-300">
            ...
            @else
                ...
                <div class="rounded-2xl p-4 sm:p-5 mb-6 text-sm text-gray-700 space-y-3" style="background-color: rgba(255, 247, 237, 0.9); border: 1.5px solid #fdba74;">
                    <div class="flex items-start gap-3">
                        <div class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style="background-color: #ffedd5; color: #ea580c;">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
