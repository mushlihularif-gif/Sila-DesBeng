                ...
                <div class="ps-detail-grid">
                    ...
                    <div class="ps-col-image">
                        <div class="ps-gallery-main group" onclick="openLightbox(document.getElementById('mainImage').src)">
                            @if($produk->foto)
                                <img src="{{ Storage::url($produk->foto) }}" alt="{{ $produk->nama_produk }}" id="mainImage" onerror="this.onerror=null; this.src='{{ asset('User/img/elemen/PasarDaerah.png') }}';">
                            @else
...
@endphp
                        ...
                        <div class="grid grid-cols-5 gap-3 mt-3">
                            ...
                            <button onclick="changeImage('{{ Storage::url($produk->foto) }}', this)" class="ps-gallery-thumb active">
                                <img src="{{ Storage::url($produk->foto) }}" onerror="this.onerror=null; this.src='{{ asset('User/img/elemen/PasarDaerah.png') }}';">
                            </button>
                            @endif
                            @if($produk->foto_2)
                            <button onclick="changeImage('{{ Storage::url($produk->foto_2) }}', this)" class="ps-gallery-thumb">
                                <img src="{{ Storage::url($produk->foto_2) }}" onerror="this.onerror=null; this.src='{{ asset('User/img/elemen/PasarDaerah.png') }}';">
                            </button>
                            @endif
                            @if($produk->foto_3)
                            <button onclick="changeImage('{{ Storage::url($produk->foto_3) }}', this)" class="ps-gallery-thumb">
                                <img src="{{ Storage::url($produk->foto_3) }}" onerror="this.onerror=null; this.src='{{ asset('User/img/elemen/PasarDaerah.png') }}';">
                            </button>
                            @endif
                        </div>
                    </div>
