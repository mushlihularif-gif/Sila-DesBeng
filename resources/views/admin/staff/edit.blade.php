    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="fw-bold py-3 mb-0">
                <span class="text-muted fw-light">Manajemen Staf /</span> Edit Staf
            </h4>
            ...
            <div class="card mb-4 border-0 shadow-sm" style="border-radius: 16px;">
                ...
                <div class="card-body mt-4 px-4 px-md-5 pb-5">
                    <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-icon-wrapper">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $staff->name) }}" required />
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-icon-wrapper">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ old('email', $staff->email) }}" required />
                                </div>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label fw-semibold" for="password">Kata Sandi Baru</label>
                            <div class="col-sm-9">
                                <div class="input-icon-wrapper">
                                    <i class="bx bx-lock-alt"></i>
                                    <input type="password" id="password" name="password" class="form-control form-control-lg @error('password') is-invalid @enderror" placeholder="Isi hanya jika ingin mengganti sandi" />
                                </div>
                                <small class="text-muted mt-1 d-block"><i class="bx bx-info-circle"></i> Biarkan kosong jika tidak ingin mengubah sandi.</small>
                                @error('password') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        <div class="row mb-5">
                            <label class="col-sm-3 col-form-label fw-semibold" for="password_confirmation">Ulangi Sandi Baru</label>
                            <div class="col-sm-9">
                                <div class="input-icon-wrapper">
                                    <i class="bx bx-check-shield"></i>
                                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-lg" placeholder="Konfirmasi kata sandi baru" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-12">
                                <div class="row g-3">
                                    @php
                                        // Gunakan data dari old() jika ada, jika tidak gunakan $activeUnits dari DB
                                        $checkedUnits = old('units', $activeUnits);
                                        if(!is_array($checkedUnits)) {
                                            $checkedUnits = [];
                                        }
                                    @endphp
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <input class="unit-card-checkbox" type="checkbox" name="units[]" value="{{ $key }}" id="unit_{{ $key }}" {{ in_array($key, $checkedUnits) ? 'checked' : '' }}>
