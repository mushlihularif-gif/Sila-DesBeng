        ...
        <div class="col-xl-8 col-lg-10 col-md-12 mx-auto">
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="mb-0 fw-bold">Edit Informasi & Hak Akses Staf</h5>
                </div>
                <div class="card-body mt-4">
                    <form action="{{ route('admin.staff.update', $staff->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-3 col-form-label" for="password">Kata Sandi (Opsional)</label>
                            <div class="col-sm-9">
                                <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Kosongkan jika tidak ingin mengubah sandi" />
                                <small class="text-muted">Isi hanya jika ingin mengganti kata sandi.</small>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Ulangi jika mengisi kata sandi baru" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    @php
                                        // Gunakan data dari old() jika ada (saat validasi gagal), jika tidak gunakan $activeUnits dari DB
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="units[]" value="{{ $key }}" id="unit_{{ $key }}" {{ in_array($key, $checkedUnits) ? 'checked' : '' }}>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-primary">Perbarui Staf</button>
