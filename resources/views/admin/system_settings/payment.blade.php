...
@section('title', 'Pengaturan Pembayaran Pusat')
@section('page-title', 'Pengaturan Pembayaran Pusat')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Admin /</span> Pengaturan Pembayaran Pusat <br> <small class="text-primary fs-6">(Admin Pusat / Admin 1)</small></h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body mt-4">
            ...
            <form action="{{ route('admin.system-settings.payment.update') }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border border-success shadow-none mb-3 bg-label-success">
                            <div class="card-body p-3">
                                ...
                                <p class="text-success small mb-3">Aktifkan jika pusat menerima pembayaran secara tunai (bayar langsung di tempat).</p>
