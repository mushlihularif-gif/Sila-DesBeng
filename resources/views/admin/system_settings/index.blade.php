...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-2 py-md-3 mb-3 mb-md-4"><span class="text-muted fw-light">Admin /</span> Pengaturan Pemerintah Kabupaten: {{ $region->name }}</h4>
    ...
    <div class="alert alert-info d-flex align-items-start mb-4 shadow-sm rounded-4 border-0 p-3 p-md-4" role="alert">
        ...
        <div>
            <h6 class="alert-heading fw-bold mb-1 text-info">Wilayah Administratif Pusat</h6>
    ...
    <form action="{{ route('admin.system-settings.update') }}" method="POST" id="region-settings-form">
        @csrf
        @method('PUT')
            ...
            <ul class="nav nav-pills mb-4 gap-2 flex-nowrap overflow-x-auto pb-1" role="tablist" style="scrollbar-width: none;">
                <li class="nav-item flex-shrink-0">
                    <button type="button" class="nav-link active rounded-pill shadow-sm px-3 px-sm-4 py-2" role="tab" data-bs-toggle="tab" data-bs-target="#navs-kontak" aria-controls="navs-kontak" aria-selected="true" style="font-size: 0.85rem;">
                        <i class="bx bx-phone-call me-1 me-sm-2"></i> Layanan Kabupaten
                    </button>
                </li>
                <li class="nav-item flex-shrink-0">
                ...
                <div class="tab-pane fade show active" id="navs-kontak" role="tabpanel">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-3 p-md-4">
                            <div class="d-flex align-items-center mb-3 border-bottom pb-3">
                                ...
                                <h6 class="fw-bold mb-0">Informasi Kontak Pusat</h6>
                            </div>
                                ...
                                <div class="card-body p-3 p-md-4">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex align-items-center me-2 overflow-hidden">
                                            ...
                                            <div>
                                                <h6 class="fw-bold {{ $isWaActive ? 'text-success' : 'text-secondary' }} mb-0 text-truncate" id="wa_title" style="font-size: 0.92rem;">Layanan Chat WhatsApp Pusat</h6>
                                            </div>
                                        </div>
                                    ...
                                    <div id="wa_fields" class="mt-3 pt-3 border-top" style="{{ !$isWaActive ? 'display: none;' : '' }}">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="whatsapp_name" id="wa_input_nama" value="{{ old('whatsapp_name', $region->payment_info['whatsapp_name'] ?? '') }}" class="form-control border-success text-success bg-white" placeholder="Cth: Admin Pusat / CS Pemkab">
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <div class="row g-3 mt-2">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold small">Email Kontak Resmi</label>
                                    <input type="email" name="contact_email" value="{{ old('contact_email', $region->contact_email) }}" class="form-control" placeholder="Cth: diskominfotik@bengkaliskab.go.id">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold small">Keterangan / Profil Wilayah</label>
                                    <input type="text" name="profile_text" value="{{ old('profile_text', $region->profile_text) }}" class="form-control" placeholder="Cth: Pusat Layanan Terpadu Silades Bengkalis">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-3 p-md-4">
                            ...
                            <div class="alert bg-label-info border-0 rounded-3 mb-4 d-flex align-items-start p-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-dark" style="font-size: 0.85rem; line-height: 1.45;">
                                        <strong>Unit Layanan Daerah:</strong> Anda dapat mengaktifkan unit layanan tingkat kabupaten (Alat, Gas, Mobil, Fasilitas Umum, Pelaporan) dan menentukan apakah layanannya berstatus eksklusif atau terbuka umum.<br>
                            ...
                            <!-- Sub-Section 1: Unit Layanan Daerah -->
                            ...
                            @foreach($operationalServices as $service)
                                @php
                                    ...
                                    elseif (strpos($sName, 'ambulans') !== false) {
                                        $iconPath = 'User/img/elemen/fasilitas.png';
                                        $descText = 'yang dapat memesan ambulans.';
                                    }
                                @endphp
                                <div class="col-md-6">
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="border-top pt-2 mt-2">
                                                ...
                                                <small class="exclusive-desc-text {{ in_array($service->id, $exclusiveServices) ? 'text-warning' : 'text-primary' }} d-block text-break" style="font-size: 0.75rem;">
                                                    {{ in_array($service->id, $exclusiveServices) ? 'Hanya warga domisili '.$region->name.' '.$descText : 'Semua warga termasuk dari luar wilayah dapat mengakses layanan ini.' }}
                                                </small>
                                            </div>
                                            ...
                                            <div class="card-body p-3 d-flex flex-column justify-content-between">
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-3 text-break" style="font-size: 0.78rem; line-height: 1.4;">
                                                        Marketplace bersama seluruh desa. Warga dapat membeli produk dari mana pun di Kabupaten Bengkalis, dan UMKM desa dapat berjualan ke seluruh wilayah tanpa dibatasi.
                                                    </p>
                                                </div>
                                                ...
                                                <div class="bg-light border rounded-3 p-2 px-3">
                                                    <div class="d-flex align-items-center justify-content-between gap-2">
                                                        ...
                                                        <i class="bx bxs-lock-alt text-secondary flex-shrink-0" title="Layanan publik kabupaten selalu aktif"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card border border-info border-opacity-25 shadow-sm rounded-3 h-100" style="background: #ffffff; max-width: 100%; overflow: hidden;">
                                            <div class="card-body p-3 d-flex flex-column justify-content-between">
                                                <div>
                                                    ...
                                                    <p class="text-muted mb-3 text-break" style="font-size: 0.78rem; line-height: 1.4;">
                                                        Pusat transparansi berita dan pengumuman daerah. Berita terbuka bagi seluruh masyarakat, sedangkan target pengumuman diatur fleksibel saat membuat pengumuman.
                                                    </p>
                                                </div>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        <div class="card-body p-3 p-md-4">
                                                        ...
                                                        <div class="flex-grow-1 pe-3">
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="text-muted small d-block mb-0">Mobil diantarkan langsung ke titik lokasi penyewa</span>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="flex-grow-1 pe-3">
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="text-muted small d-block mb-0">Penyewa datang menjemput mobil di kantor atau garasi</span>
                                                                </div>
                                                            </div>
                                                            <div class="dynamic-keterangan mt-2" style="display: none;">
                                                                <div class="d-flex align-items-start rounded-3 p-2 border" style="background-color: #e7f1ff; border-color: #b8daff; color: #004085;">
                                        ...
                                        <div class="tab-pane fade" id="box_delivery_alat" role="tabpanel" aria-labelledby="v-pills-alat-tab">
                                            <div class="d-flex align-items-center mb-4">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Atur cara alat diserahkan ke warga.</small>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="flex-grow-1 pe-3">
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="text-muted small d-block mb-0">Petugas mengantar alat ke lokasi warga</span>
                                                                </div>
                                                            </div>
                                                            <div class="dynamic-keterangan mt-2" style="display: none;">
                                                                <div class="d-flex align-items-start rounded-3 p-2 border" style="background-color: #e7f1ff; border-color: #b8daff; color: #004085;">
                                            ...
                                            <div class="d-flex flex-column gap-3">
                                                <div class="bg-light p-3 rounded-4 border">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="flex-grow-1 pe-3">
                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('Admin/img/elements/antar.png') }}" alt="Layanan Antar (Kurir)" style="width: 45px; height: 45px; object-fit: contain;" class="me-3">
                                                                <div>
                                                                    <span class="text-dark fw-bold d-block" style="font-size: 1.05rem;">Layanan Antar (Kurir)</span>
                                                        ...
                                                        <div class="flex-grow-1 pe-3">
                                                            <div class="d-flex align-items-center mb-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <span class="text-muted small d-block mb-0">Fasilitas (seperti ambulans, transportasi lain) atau petugas datang ke lokasi warga</span>
                                                                </div>
                                                            </div>
                                                            <div class="dynamic-keterangan mt-2" style="display: none;">
                                                                <div class="d-flex align-items-start rounded-3 p-2 border" style="background-color: #e7f1ff; border-color: #b8daff; color: #004085;">
                                            ...
                                            <div class="row g-4 border-top pt-4">
                                                <div class="col-12">
                                                    ...
                                                    <select name="fasilitas_bbm" class="form-select text-dark shadow-sm rounded-3 py-2">
                                                        ...
                                                        <option value="Pemerintah Desa" {{ ($region->payment_info['fasilitas_bbm_default'] ?? '') == 'Pemerintah Desa' ? 'selected' : '' }}>Gratis (Ditanggung Pemerintah)</option>
                                                    </select>
                                                </div>
                                                <div class="col-12">
                            ...
                            <div id="empty_delivery_state" class="text-center py-5" style="display: none;">
                                ...
                                <p class="text-muted small mb-0 px-md-5">Silakan aktifkan layanan (seperti Mobil, Alat, atau Penjualan Gas) di tab <b>Layanan Kabupaten</b> terlebih dahulu agar pengaturannya muncul di sini.</p>
                            </div>
                ...
                if(el.checked) {
                    ...
                    if(descContainer) {
                        ...
                        if (isPengumuman) {
                            ...
                            descContainer.innerText = 'Semua warga termasuk dari luar wilayah dapat mengakses layanan ini.';
                        }
                    }
                }
            }
