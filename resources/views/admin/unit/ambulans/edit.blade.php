...
@php
    ...
    $existingPhotoUrl = $ambulans->foto ? asset('storage/' . $ambulans->foto) : null;
    $existingPhoto2Url = $ambulans->foto_2 ? asset('storage/' . $ambulans->foto_2) : null;
    $existingPhoto3Url = $ambulans->foto_3 ? asset('storage/' . $ambulans->foto_3) : null;
    $selectedSupirIds = old('supir_ids', $ambulans->supirs->pluck('id')->toArray());
@endphp
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-1">
                ...
                </span> Ubah Armada Kendaraan
            </h4>
            <p class="text-muted mb-0 small">Perbarui data spesifikasi, plat registrasi polisi, atau rotasi supir penanggung jawab.</p>
        </div>
            ...
            <div class="card modern-card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-bottom py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-dark">Formulir Pembaruan Kendaraan</h5>
                            <small class="text-muted">Sesuaikan detail identitas kendaraan beserta foto dan penugasan supir.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.unit.ambulans.update', $ambulans->id) }}" method="POST" enctype="multipart/form-data" id="ambulansForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="nama_mobil" 
                                           id="inputNamaMobil"
                                           value="{{ old('nama_mobil', $ambulans->nama_mobil) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-select modern-input" 
                                        ...
                                        <option value="ambulans" {{ old('kategori', $ambulans->kategori) == 'ambulans' ? 'selected' : '' }}>Ambulans (Tersedia Supir Siaga Darurat 24 Jam)</option>
                                        <option value="kendaraan_operasional" {{ old('kategori', $ambulans->kategori) == 'kendaraan_operasional' ? 'selected' : '' }}>Kendaraan Operasional Umum (Bus, Truk, Pick Up)</option>
                                    </select>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="upload-box" onclick="document.getElementById('foto').click()">
                                        ...
                                        <div id="placeholder_foto" class="upload-placeholder py-2" style="{{ $existingPhotoUrl ? 'display:none;' : 'display:block;' }}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="upload-box" onclick="document.getElementById('foto_2').click()">
                                        ...
                                        <div id="placeholder_foto_2" class="upload-placeholder py-2" style="{{ $existingPhoto2Url ? 'display:none;' : 'display:block;' }}">
                                            <i class='bx bx-cloud-upload text-primary' style="font-size: 38px;"></i>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="upload-box" onclick="document.getElementById('foto_3').click()">
                                        ...
                                        <div id="placeholder_foto_3" class="upload-placeholder py-2" style="{{ $existingPhoto3Url ? 'display:none;' : 'display:block;' }}">
                                            <i class='bx bx-cloud-upload text-primary' style="font-size: 38px;"></i>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" 
                                           ...
                                           name="nomor_plat" 
                                           id="inputPlat" 
                                           value="{{ old('nomor_plat', $cleanPlat) }}"
                            ...
                            <div class="row g-3" id="driverCardsContainer">
                                @forelse($supirs as $supir)
                                    @php
                                        ...
                                        $isSelected = in_array($supir->id, $selectedSupirIds);
                                    @endphp
                        ...
                        <div class="d-flex align-items-center justify-content-between pt-3 border-top mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4 shadow-sm" id="btnSubmitForm">
                                <i class="bx bx-save me-1"></i> Perbarui Armada Kendaraan
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="card modern-card shadow-sm border-0 mb-4">
                    <div class="card-header bg-white border-bottom py-3">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <span class="badge bg-label-primary font-11" id="previewKategoriBadge">
                                {{ $ambulans->kategori == 'ambulans' ? 'Ambulans Siaga' : 'Kendaraan Operasional' }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="card-body text-center p-4">
                        <!-- Nama Preview -->
                        <h5 class="fw-extrabold text-dark mb-1" id="previewNamaMobil">{{ $ambulans->nama_mobil }}</h5>
                        <p class="text-muted small mb-4" id="previewSubtext">
                            {{ $ambulans->kategori == 'ambulans' ? 'Layanan Tanggap Darurat Medis Warga 24 Jam' : 'Armada Logistik & Mobilitas Kegiatan Desa' }}
                        </p>
