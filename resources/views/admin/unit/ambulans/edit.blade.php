...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light"><a href="{{ route('admin.unit.ambulans.index') }}">Kendaraan Operasional</a> /</span> Edit Kendaraan
    </h4>
        ...
        <div class="col-xl-7 col-lg-7">
            <div class="card mb-4 shadow-sm border-0">
                <div class="card-header bg-white border-bottom pt-4 pb-3">
                    <h5 class="mb-0 text-primary fw-bold"><i class="bx bx-edit me-2"></i>Edit Data Kendaraan</h5>
                    <small class="text-muted">Perbarui detail kendaraan operasional beserta data penanggung jawab (supir).</small>
                </div>
                <div class="card-body pt-4">
                    <form action="{{ route('admin.unit.ambulans.update', $ambulans->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" name="nama_mobil" value="{{ $ambulans->nama_mobil }}" placeholder="Misal: Ambulans Siaga, Truk Sampah, Bus Desa" required>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-box border rounded p-3 text-center" style="cursor: pointer; border-style: dashed !important;" onclick="document.getElementById('foto').click()">
                                <div id="preview_foto" class="preview-container position-relative" style="{{ $ambulans->foto ? 'display:block;' : 'display:none;' }}">
                                    <img src="{{ $ambulans->foto ? asset('storage/' . $ambulans->foto) : '#' }}" alt="Preview" class="preview-image img-fluid rounded" style="max-height: 200px; object-fit: cover;" />
                                ...
                                <div id="placeholder_foto" class="upload-placeholder py-4" style="{{ $ambulans->foto ? 'display:none;' : 'display:block;' }}">
                                    <i class='bx bx-cloud-upload text-primary' style="font-size: 48px;"></i>
                                    <p class="mb-0 mt-2 fw-semibold">Klik untuk upload foto baru</p>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control text-uppercase" name="nomor_plat" id="inputPlat" value="{{ str_replace('Plat: ', '', $ambulans->deskripsi) }}" placeholder="Misal: BM 1234 DV" required maxlength="12">
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" class="form-control" name="nama_supir" value="{{ $ambulans->nama_supir }}" placeholder="Ketik nama lengkap supir..." required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control" name="kontak_supir" value="{{ $ambulans->kontak_supir }}" placeholder="Misal: 081234567890" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="bx bx-save me-1"></i> Perbarui Data</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="card-body text-center pt-5 pb-5">
                    ...
                    <div class="position-relative d-inline-block mx-auto" style="max-width: 300px;">
                        ...
                        <div class="position-absolute w-100 d-flex justify-content-center align-items-center" style="bottom: 32%; left: 0;">
                            @php $initialPlat = str_replace('Plat: ', '', $ambulans->deskripsi); @endphp
                            <span id="previewPlatText" style="font-family: 'Arial Black', Impact, sans-serif; font-size: 0.55rem; font-weight: 900; color: #111; letter-spacing: 0px; line-height: 1;">{{ $initialPlat ?: 'BM XXXX XX' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 p-3 bg-light rounded text-center border">
                        ...
                        <h3 id="previewPlatTextStatic" class="text-dark fw-bolder mb-0" style="letter-spacing: 2px;">{{ $initialPlat ?: 'BM XXXX XX' }}</h3>
                    </div>
