    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mb-4">
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Unit Layanan / Penjualan Gas /</span> Edit Gas
            </h4>
            <p class="text-muted mb-0">Perbarui informasi produk gas</p>
        </div>
                ...
                <div class="card modern-card shadow-sm">
                    <div class="card-header bg-white border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">Form Edit Produk Gas</h5>
                                <small class="text-muted">Ubah detail produk gas yang akan dijual</small>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="upload-box" onclick="document.getElementById('foto').click()">
                                            @if($gas->foto)
                                                <div id="preview_foto" class="preview-container">
                                                    <img src="{{ asset('storage/' . $gas->foto) }}" alt="{{ $gas->jenis_gas }}" class="preview-image" />
                                        ...
                                        <div class="upload-box" onclick="document.getElementById('foto_2').click()">
                                            @if($gas->foto_2)
                                                <div id="preview_foto_2" class="preview-container">
                                                    <img src="{{ asset('storage/' . $gas->foto_2) }}" alt="{{ $gas->jenis_gas }}" class="preview-image" />
                                        ...
                                        <div class="upload-box" onclick="document.getElementById('foto_3').click()">
                                            @if($gas->foto_3)
                                                <div id="preview_foto_3" class="preview-container">
                                                    <img src="{{ asset('storage/' . $gas->foto_3) }}" alt="{{ $gas->jenis_gas }}" class="preview-image" />
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control modern-input" id="jenis_gas" 
                                               name="jenis_gas" value="{{ old('jenis_gas', $gas->jenis_gas) }}" 
                                               placeholder="Contoh: LPG 3 Kg" required />
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <select class="form-select modern-input" id="kategori" name="kategori" required>
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ $category->name }}" {{ old('kategori', $gas->kategori) == $category->name ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control modern-input" id="deskripsi" name="deskripsi" 
                                                  rows="4" placeholder="Jelaskan detail produk gas, spesifikasi, dan kegunaan..." required>{{ old('deskripsi', $gas->deskripsi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control modern-input" id="harga_satuan" 
                                                   name="harga_satuan" value="{{ old('harga_satuan', number_format($gas->harga_satuan, 0, ',', '.')) }}" 
                                                   placeholder="21.000" required oninput="formatRupiah(this)" />
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control modern-input" id="stok" 
                                               name="stok" value="{{ old('stok', $gas->stok) }}" 
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control modern-input" id="lokasi"
                                                       name="lokasi" value="{{ old('lokasi', $gas->lokasi ?? (auth()->user()->region->name ?? '')) }}" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control modern-input" id="latitude" name="latitude" value="{{ old('latitude', $gas->latitude) }}" placeholder="1.4854" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-semibold" for="longitude">Longitude (Opsional)</label>
                                                <input type="text" class="form-control modern-input" id="longitude" name="longitude" value="{{ old('longitude', $gas->longitude) }}" placeholder="102.1512" />
                                            </div>
...
<script>
    ...
    // Sama dengan halaman Tambah; halaman Ubah sebelumnya tidak punya peta
    // sama sekali, jadi koordinat hanya bisa diketik manual.
    // ====================================================================
    (function () {
        ...
        let peta = null, penanda = null, saranTerpasang = false;
        ...
        function pasangSaran() {
            ...
            pasangSaranAlamat(cari, function (t) {
                ...
                // Nama tempat dari Google TIDAK menimpa lokasi produk yang sudah
                // tersimpan — di halaman Ubah kolom itu hampir selalu sudah terisi
                // dan nilainya milik petugas, bukan tebakan Google.
                if (t.nama && !inNama.value.trim()) inNama.value = t.nama;
            });
        }

        window.pasangPetaGas = function () { pasangPeta(); pasangSaran(); };
