...
<!-- Section: Foto Produk -->
                            ...
                            <div class="form-section mb-4 mt-4">
                                ...
                                @php
                                    $opsiSupirHarian = old('opsi_supir', $mobil->opsi_supir ?? 'Lepas Kunci');
                                    $isTanpaSupirHarian = in_array($opsiSupirHarian, ['Lepas Kunci', 'Bebas Pilih']);
                                    $isDenganSupirHarian = in_array($opsiSupirHarian, ['Dengan Supir', 'Bebas Pilih']);
                                    $bbmHarian = old('bbm_ditanggung', $mobil->bbm_ditanggung ?? 'Penyewa');
                                    $isBbmDesaHarian = in_array($bbmHarian, ['Pengelola', 'Pemerintah Desa']);
                                @endphp
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isTanpaSupirHarian ? 'border-primary bg-primary-subtle' : '' }}" id="card_supir_tanpa_harian" onclick="toggleSupirTanpaCardHarian(event)">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge {{ $isTanpaSupirHarian ? 'bg-success' : 'bg-label-secondary' }} small" id="status_tanpa_supir">{{ $isTanpaSupirHarian ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-check form-switch fs-5 mb-0">
                                                    <input class="form-check-input cursor-pointer" type="checkbox" id="switch_tanpa_supir" onchange="updateSupirStatus()" {{ $isTanpaSupirHarian ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isDenganSupirHarian ? 'border-primary bg-primary-subtle' : '' }}" id="card_supir_dengan_harian" onclick="toggleSupirDenganCardHarian(event)">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge {{ $isDenganSupirHarian ? 'bg-success' : 'bg-label-secondary' }} small" id="status_dengan_supir">{{ $isDenganSupirHarian ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-check form-switch fs-5 mb-0">
                                                    <input class="form-check-input cursor-pointer" type="checkbox" id="switch_dengan_supir" onchange="updateSupirStatus()" {{ $isDenganSupirHarian ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                ...
                                <input type="hidden" name="opsi_supir" id="opsi_supir" value="{{ $opsiSupirHarian }}">
                                ...
                                <div class="row g-3 mb-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isBbmDesaHarian ? 'border-primary bg-primary-subtle' : '' }}" id="card_bbm_desa" onclick="selectBbmHarian('Pengelola')">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge {{ $isBbmDesaHarian ? 'bg-success' : 'bg-label-secondary' }} small" id="status_bbm_desa">{{ $isBbmDesaHarian ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-check form-switch fs-5 mb-0">
                                                    <input class="form-check-input cursor-pointer" type="radio" name="bbm_switch" id="switch_bbm_desa" value="Pengelola" onchange="updateBbmStatus()" {{ $isBbmDesaHarian ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ !$isBbmDesaHarian ? 'border-primary bg-primary-subtle' : '' }}" id="card_bbm_penyewa" onclick="selectBbmHarian('Penyewa')">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="badge {{ !$isBbmDesaHarian ? 'bg-success' : 'bg-label-secondary' }} small" id="status_bbm_penyewa">{{ !$isBbmDesaHarian ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                    </div>
                                                </div>
                                                <div class="form-check form-switch fs-5 mb-0">
                                                    <input class="form-check-input cursor-pointer" type="radio" name="bbm_switch" id="switch_bbm_penyewa" value="Penyewa" onchange="updateBbmStatus()" {{ !$isBbmDesaHarian ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                ...
                                <input type="hidden" name="bbm_ditanggung" id="bbm_ditanggung" value="{{ $bbmHarian }}" required>
                            </div>
                                        ...
                                        <div id="borongan_content_wrapper">
                                            <div id="borongan_wilayah_wrapper">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge border-light-subtle shadow-sm rounded-3">
                                                        ...
                                                        <input type="text" class="form-control fw-semibold" id="harga_dalam_desa_wilayah" name="harga_dalam_desa_wilayah" 
                                                            value="{{ old('harga_dalam_desa_wilayah', isset($mobil) && $mobil->harga_dalam_desa_wilayah ? number_format($mobil->harga_dalam_desa_wilayah, 0, ',', '.') : '') }}" oninput="formatRupiah(this)" placeholder="100.000">
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group input-group-merge border-light-subtle shadow-sm rounded-3">
                                                        ...
                                                        <input type="text" class="form-control fw-semibold" id="harga_luar_desa_wilayah" name="harga_luar_desa_wilayah" 
                                                            value="{{ old('harga_luar_desa_wilayah', isset($mobil) && $mobil->harga_luar_desa_wilayah ? number_format($mobil->harga_luar_desa_wilayah, 0, ',', '.') : '') }}" oninput="formatRupiah(this)" placeholder="150.000">
                                                    </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    @php
                                                        $currentTipeLuar = old('tipe_luar_kecamatan_wilayah', $mobil->tipe_luar_kecamatan_wilayah ?? 'pukul_rata');
                                                    @endphp
                                                    <div class="row g-3 mb-4">
                                                        <div class="col-md-6">
                                                            <div class="d-flex align-items-center gap-3 p-3 border rounded-3 w-100" style="cursor: pointer; transition: all 0.2s;" id="label_pukul_rata" onclick="setOngkirType('pukul_rata')">
                                                                <input type="radio" name="tipe_luar_kecamatan_wilayah" id="tipe_pukul_rata" value="pukul_rata" class="form-check-input mt-0" style="transform: scale(1.2);" {{ $currentTipeLuar == 'pukul_rata' ? 'checked' : '' }} onchange="setOngkirType('pukul_rata')">
                                                                <div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="d-flex align-items-center gap-3 p-3 border rounded-3 w-100" style="cursor: pointer; transition: all 0.2s;" id="label_per_kecamatan" onclick="setOngkirType('per_kecamatan')">
                                                                <input type="radio" name="tipe_luar_kecamatan_wilayah" id="tipe_per_kecamatan" value="per_kecamatan" class="form-check-input mt-0" style="transform: scale(1.2);" {{ $currentTipeLuar == 'per_kecamatan' ? 'checked' : '' }} onchange="setOngkirType('per_kecamatan')">
                                                                <div>
                                                    ...
                                                    <!-- Opsi Pukul Rata -->
                                                    <div id="div_pukul_rata" class="mt-3 p-3 bg-light rounded-4 border" style="display: {{ $currentTipeLuar == 'pukul_rata' ? 'block' : 'none' }};">
                                                        ...
                                                        <div class="input-group input-group-merge border-light-subtle shadow-sm rounded-3">
                                                            ...
                                                            <input type="text" class="form-control fw-semibold border-start-0" id="harga_luar_kecamatan_wilayah" name="harga_luar_kecamatan_wilayah" 
                                                                value="{{ old('harga_luar_kecamatan_wilayah', isset($mobil) && $mobil->harga_luar_kecamatan_wilayah ? number_format($mobil->harga_luar_kecamatan_wilayah, 0, ',', '.') : '') }}" oninput="formatRupiah(this)" placeholder="250.000">
                                                        </div>
                                                        <small class="text-muted mt-2 d-block">Tarif otomatis berlaku untuk semua tujuan kecamatan lain.</small>
                                                    </div>

                                                    <!-- Opsi Per Kecamatan -->
                                                    <div id="div_per_kecamatan" class="mt-3" style="display: {{ $currentTipeLuar == 'per_kecamatan' ? 'block' : 'none' }};">
                                                                ...
                                                                <tbody class="table-border-bottom-0">
                                                                    @foreach($semuaKecamatan as $kec)
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <label class="form-check-label fw-medium {{ $isKecActive ? 'text-dark' : 'text-muted' }}" id="label_kec_{{ $kec->id }}" for="switch_kec_{{ $kec->id }}">
                                                                                    {{ $kec->name }}
                                                                                </label>
                                                                            </td>
                                                                            <td class="pe-3">
                                                                                <div class="input-group input-group-sm">
                                                                                    ...
                                                                                    <input type="text" class="form-control text-end fw-semibold" 
                                                                                        ...
                                                                                        value="{{ $nominalKec }}" placeholder="0" {{ $isKecActive ? '' : 'disabled' }} oninput="formatRupiah(this)">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                            ...
                                            <div class="form-section mb-4 mt-4">
                                                ...
                                                @php
                                                    $opsiSupirBorongan = old('opsi_supir_borongan', $mobil->opsi_supir_borongan ?? 'Lepas Kunci');
                                                    $isTanpaSupirBorongan = in_array($opsiSupirBorongan, ['Lepas Kunci', 'Bebas Pilih']);
                                                    $isDenganSupirBorongan = in_array($opsiSupirBorongan, ['Dengan Supir', 'Bebas Pilih']);
                                                    $bbmBorongan = old('bbm_ditanggung_borongan', $mobil->bbm_ditanggung_borongan ?? 'Penyewa');
                                                @endphp
                                                ...
                                                <div class="row g-3 mb-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isTanpaSupirBorongan ? 'border-success bg-success-subtle' : '' }}" id="card_supir_tanpa_borongan" onclick="toggleSupirTanpaCardBorongan(event)">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <img src="{{ asset('User/img/iconbaru/supirsendiri.png') }}" style="width: 38px; height: 38px; object-fit: contain;">
                                                                    <div>
                                                                        <h6 class="mb-0 fw-bold text-dark">Sewa Tanpa Supir (Bawa Sendiri)</h6>
                                                                        <span class="badge {{ $isTanpaSupirBorongan ? 'bg-success' : 'bg-label-secondary' }} small" id="status_tanpa_supir_borongan">{{ $isTanpaSupirBorongan ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-check form-switch fs-5 mb-0">
                                                                    <input class="form-check-input cursor-pointer" type="checkbox" id="switch_tanpa_supir_borongan" onchange="updateSupirStatusBorongan()" {{ $isTanpaSupirBorongan ? 'checked' : '' }}>
                                                                </div>
                                                            </div>
                                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isDenganSupirBorongan ? 'border-success bg-success-subtle' : '' }}" id="card_supir_dengan_borongan" onclick="toggleSupirDenganCardBorongan(event)">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <img src="{{ asset('User/img/iconbaru/disediakansupir.png') }}" style="width: 38px; height: 38px; object-fit: contain;">
                                                                    <div>
                                                                        <h6 class="mb-0 fw-bold text-dark">Sewa Dengan Supir Pengelola</h6>
                                                                        <span class="badge {{ $isDenganSupirBorongan ? 'bg-success' : 'bg-label-secondary' }} small" id="status_dengan_supir_borongan">{{ $isDenganSupirBorongan ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-check form-switch fs-5 mb-0">
                                                                    <input class="form-check-input cursor-pointer" type="checkbox" id="switch_dengan_supir_borongan" onchange="updateSupirStatusBorongan()" {{ $isDenganSupirBorongan ? 'checked' : '' }}>
                                                                </div>
                                                            </div>
                                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                                ...
                                                <input type="hidden" name="opsi_supir_borongan" id="opsi_supir_borongan" value="{{ $opsiSupirBorongan }}">
                                                ...
                                                @php
                                                    $isBbmDesaBorongan = in_array($bbmBorongan, ['Pengelola', 'Pemerintah Desa']);
                                                @endphp
                                                <div class="row g-3 mb-4">
                                                    <!-- BBM Disediakan Pengelola Borongan -->
                                                    <div class="col-md-6">
                                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ $isBbmDesaBorongan ? 'border-success bg-success-subtle' : '' }}" id="card_bbm_desa_borongan" onclick="selectBbmBorongan('Pemerintah Desa')">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <img src="{{ asset('User/img/iconbaru/bbmdisediakan.png') }}" style="width: 38px; height: 38px; object-fit: contain;">
                                                                    <div>
                                                                        <h6 class="mb-0 fw-bold text-dark">BBM Disediakan Pengelola</h6>
                                                                        <span class="badge {{ $isBbmDesaBorongan ? 'bg-success' : 'bg-label-secondary' }} small" id="status_bbm_desa_borongan">{{ $isBbmDesaBorongan ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-check form-switch fs-5 mb-0">
                                                                    <input class="form-check-input cursor-pointer" type="radio" name="bbm_switch_borongan" id="switch_bbm_desa_borongan" value="Pemerintah Desa" onchange="updateBbmStatusBorongan()" {{ $isBbmDesaBorongan ? 'checked' : '' }}>
                                                                </div>
                                                            </div>
                                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="p-3 border rounded-3 bg-white h-100 cursor-pointer shadow-sm position-relative transition-all {{ !$isBbmDesaBorongan ? 'border-success bg-success-subtle' : '' }}" id="card_bbm_penyewa_borongan" onclick="selectBbmBorongan('Penyewa')">
                                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    <img src="{{ asset('User/img/iconbaru/bbmditanggungpengguna.png') }}" style="width: 38px; height: 38px; object-fit: contain;">
                                                                    <div>
                                                                        <h6 class="mb-0 fw-bold text-dark">BBM Ditanggung Penyewa</h6>
                                                                        <span class="badge {{ !$isBbmDesaBorongan ? 'bg-success' : 'bg-label-secondary' }} small" id="status_bbm_penyewa_borongan">{{ !$isBbmDesaBorongan ? 'Aktif' : 'Tidak Aktif' }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-check form-switch fs-5 mb-0">
                                                                    <input class="form-check-input cursor-pointer" type="radio" name="bbm_switch_borongan" id="switch_bbm_penyewa_borongan" value="Penyewa" onchange="updateBbmStatusBorongan()" {{ !$isBbmDesaBorongan ? 'checked' : '' }}>
                                                                </div>
                                                            </div>
                                                            <p class="text-muted small mb-0 mt-2" style="font-size: 0.825rem; line-height: 1.4;">
                                                ...
                                                <input type="hidden" name="bbm_ditanggung_borongan" id="bbm_ditanggung_borongan" value="{{ $bbmBorongan }}" required>
                                ...
                                <div class="tab-pane fade" id="step4" role="tabpanel" aria-labelledby="step4-tab">
                                            ...
                                            <div class="col-md-12 mb-3" id="saved_location_container" style="display: none;">
                                                ...
                                                <select class="form-select modern-input" id="saved_lokasi" onchange="fillLocationData(this)">
                                                    ...
                                                    @foreach($savedLocations as $loc)
                                                        <option value="{{ $loc->lokasi }}" {{ $mobil->lokasi == $loc->lokasi ? 'selected' : '' }}>
                                                            {{ $loc->lokasi }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control modern-input" id="lokasi" 
                                                               name="lokasi" value="{{ old('lokasi', $mobil->lokasi) }}" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-stretch align-items-sm-center gap-2 mt-4 pt-3 border-top">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <button type="submit" class="btn btn-success flex-grow-1 flex-sm-grow-0"><i class='bx bx-save me-1'></i> Simpan Perubahan</button>
                                        </div>
                                    </div>
                                </div> <!-- End Step 4 -->
                            </div> <!-- End tab-content -->
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        setOngkirType('{{ $tipeLuarKecamatan ?? "pukul_rata" }}');
