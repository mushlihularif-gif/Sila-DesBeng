                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.unit.mobil.sop.update') }}" method="POST">
                            ...
                            <div class="row mb-4">
                                    ...
                                    <div class="card sop-card {{ $sop_active == 'ditanggung' ? 'active-sop' : '' }} h-100">
                                        <div class="card-header d-flex justify-content-between align-items-center pb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sop_mobil_active" id="sop_active_ditanggung" value="ditanggung" {{ $sop_active == 'ditanggung' ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            <p class="text-muted small mb-2">Kerusakan atau kehilangan mobil menjadi tanggung jawab pengguna.</p>
                                            
                                            <div class="mb-3">
                                                <textarea class="form-control" name="sop_mobil_ditanggung" id="sop_ditanggung_text" rows="8">{{ old('sop_mobil_ditanggung', $sop_ditanggung) }}</textarea>
                                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card sop-card {{ $sop_active == 'tidak_ditanggung' ? 'active-sop' : '' }} h-100">
                                        <div class="card-header d-flex justify-content-between align-items-center pb-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="sop_mobil_active" id="sop_active_tidak_ditanggung" value="tidak_ditanggung" {{ $sop_active == 'tidak_ditanggung' ? 'checked' : '' }}>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <textarea class="form-control" name="sop_mobil_tidak_ditanggung" id="sop_tidak_ditanggung_text" rows="8">{{ old('sop_mobil_tidak_ditanggung', $sop_tidak_ditanggung) }}</textarea>
                                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.unit.mobil.index') }}" class="btn btn-outline-secondary">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    ...
    document.querySelectorAll('input[name="sop_mobil_active"]').forEach(function(radio) {
