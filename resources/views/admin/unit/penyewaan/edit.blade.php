                            ...
                            <div class="form-section mb-4">
                                ...
                                <div class="tab-pane fade" id="step3" role="tabpanel" aria-labelledby="step3-tab">
                                    ...
                                    <div class="form-section mb-4 border border-info rounded p-3 bg-light">
                                        ...
                                        <p class="text-muted small">Fitur ini terhubung langsung dengan Pengaturan Wilayah. Perubahan di sini otomatis tersimpan dan memengaruhi seluruh layanan <b>Penyewaan</b>.</p>
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <div class="form-check form-switch form-switch-md">
                                                    <input class="form-check-input delivery-toggle" type="checkbox" id="delivery_antar" data-field="alat_delivery_antar_active" {{ !empty($paymentInfo['alat_delivery_antar_active']) ? 'checked' : '' }}>
                                                    <label class="form-check-label fw-bold ms-2" for="delivery_antar">Sediakan Jasa Diantar</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-check form-switch form-switch-md">
                                                    <input class="form-check-input delivery-toggle" type="checkbox" id="delivery_jemput" data-field="alat_delivery_jemput_active" {{ !empty($paymentInfo['alat_delivery_jemput_active']) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12" id="new_location_container">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control modern-input" id="latitude" name="latitude" value="{{ old('latitude', $barang->latitude) }}" placeholder="-6.200000" />
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-semibold" for="longitude">Longitude (Opsional)</label>
                                                <input type="text" class="form-control modern-input" id="longitude" name="longitude" value="{{ old('longitude', $barang->longitude) }}" placeholder="106.816666" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
