    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mb-4">
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Unit Layanan / Pasar Daerah /</span> Tambah Produk
            </h4>
            <p class="text-muted mb-0">Lengkapi formulir di bawah untuk menambahkan produk baru</p>
        </div>
                ...
                <div class="card modern-card shadow-sm">
                    <div class="card-header bg-white border-bottom">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h5 class="mb-0 fw-bold">Form Tambah Produk Pasar Daerah</h5>
                                <small class="text-muted">Masukkan detail produk yang akan dijual</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.unit.pasar_daerah.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-7">
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="{{ old('nama_produk') }}" required placeholder="Contoh: Beras Premium" />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Jelaskan detail produk...">{{ old('deskripsi') }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="number" class="form-control" id="harga" name="harga" value="{{ old('harga') }}" required min="0" placeholder="0" />
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label fw-semibold" for="satuan">Satuan</label>
                                                <input type="text" class="form-control" id="satuan" name="satuan" value="{{ old('satuan', 'pcs') }}" placeholder="Contoh: kg, liter, pcs" />
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label fw-semibold" for="stok">Stok <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" id="stok" name="stok" value="{{ old('stok') }}" required min="0" placeholder="Jumlah stok" />
                                            </div>
                                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-5">
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold" for="foto">Foto Utama (Wajib)</label>
                                    ...
                                    <div class="form-section mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="lokasi" name="lokasi" rows="2" placeholder="Alamat lengkap toko / penjual">{{ old('lokasi') }}</textarea>
                                        </div>
                            ...
                            <div class="border-top pt-4 mt-2 d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="bx bx-save me-1"></i> Simpan Produk</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Set default view ke Bengkalis
            var lat = {{ old('latitude', '1.47271') }};
            var lng = {{ old('longitude', '102.13886') }};
            ...
            var marker = L.marker([lat, lng], { draggable: true, icon: defaultIcon }).addTo(map);
            ...
            // Jika tidak ada input lama, kosongkan
