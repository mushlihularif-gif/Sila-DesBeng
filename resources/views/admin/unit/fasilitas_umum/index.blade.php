...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Unit Layanan /</span> Peminjaman Fasilitas Umum</h4>
            ...
            <div>
                <a href="{{ route('admin.unit.fasilitas_umum.sop') }}" class="btn btn-outline-info me-2">Manajemen SOP</a>
            ...
            <div class="mt-4 d-flex justify-content-center">
                <nav>
                    <ul class="pagination mb-0">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $fasilitas->previousPageUrl() }}" rel="prev">« Sebelumnya</a>
                            </li>
                        @endif
                        ...
                        @if ($fasilitas->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $fasilitas->nextPageUrl() }}" rel="next">Selanjutnya »</a>
                            </li>
                        @else
                            <li class="page-item disabled">
