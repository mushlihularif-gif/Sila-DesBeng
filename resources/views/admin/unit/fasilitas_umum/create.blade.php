    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="mb-4">
            <h4 class="fw-bold mb-1">
                <span class="text-muted fw-light">Unit Layanan / Peminjaman Fasilitas Umum /</span> Tambah Alat
            </h4>
            ...
            <div class="col-xl-12">
                <div class="card modern-card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.unit.Fasilitas Umum.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
