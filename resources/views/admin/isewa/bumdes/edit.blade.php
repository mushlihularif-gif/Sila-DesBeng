                            ...
                            <div class="col-md-9">
                                <div class="row g-3">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-check border rounded-3 p-3 h-100 bg-white shadow-sm">
                                                    <label class="form-check-label d-flex align-items-start cursor-pointer w-100" for="level_1">
                                                        <input name="level" class="form-check-input me-2 mt-1" type="radio" value="1" id="level_1" {{ old('level', $member->level ?? 1) == 1 ? 'checked' : '' }} required>
                                                        <span>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-check border rounded-3 p-3 h-100 bg-white shadow-sm">
                                                    <label class="form-check-label d-flex align-items-start cursor-pointer w-100" for="level_2">
                                                        <input name="level" class="form-check-input me-2 mt-1" type="radio" value="2" id="level_2" {{ old('level', $member->level ?? 1) == 2 ? 'checked' : '' }} required>
                                                        <span>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-check border rounded-3 p-3 h-100 bg-white shadow-sm">
                                                    <label class="form-check-label d-flex align-items-start cursor-pointer w-100" for="level_3">
                                                        <input name="level" class="form-check-input me-2 mt-1" type="radio" value="3" id="level_3" {{ old('level', $member->level ?? 1) == 3 ? 'checked' : '' }} required>
                                                        <span>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-check border rounded-3 p-3 h-100 bg-white shadow-sm">
                                                    <label class="form-check-label d-flex align-items-start cursor-pointer w-100" for="level_4">
                                                        <input name="level" class="form-check-input me-2 mt-1" type="radio" value="4" id="level_4" {{ old('level', $member->level ?? 1) == 4 ? 'checked' : '' }} required>
                                                        <span>
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <small class="text-muted d-block mt-1">Urutan posisi dalam baris tingkatan yang sama.</small>
                                        @error('order')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
