                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="showSiladesBengToast('info', 'Informasi', 'Fitur Edit sedang disiapkan.')" class="p-2 text-blue-600 bg-gray-50 hover:bg-blue-500 hover:text-white rounded-lg transition-all" title="Edit">
