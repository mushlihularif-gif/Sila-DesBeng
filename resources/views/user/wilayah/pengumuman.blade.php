                            ...
                            <div class="p-6 flex-1 flex flex-col">
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="showSiladesBengToast('info', 'Informasi', 'Fitur Edit sedang disiapkan.')" class="p-2 text-blue-600 bg-blue-50 hover:bg-blue-600 hover:text-white rounded-lg transition-all" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        </button>
                                        <button onclick="showSiladesBengToast('info', 'Informasi', 'Fitur Hapus sedang disiapkan.')" class="p-2 text-red-600 bg-red-50 hover:bg-red-600 hover:text-white rounded-lg transition-all" title="Hapus">
