...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn('rental_bookings', 'deleted_at')) {
            ...
            echo "Tabel 'rental_bookings' tidak memiliki kolom 'deleted_at', skip\n";
        }

        // Hapus deleted_at dari gas_orders
        if (Schema::hasColumn('gas_orders', 'deleted_at')) {
            ...
            echo "Tabel 'gas_orders' tidak memiliki kolom 'deleted_at', skip\n";
        }
    }
